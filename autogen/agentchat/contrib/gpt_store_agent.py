...
from aix.utils.misc import retrieve_gpt_assistants_by_name
...
class GptStoreAgent(ConversableAgent):
    """
    An experimental AutoGen agent class that leverages the OpenAI GPT Store for conversational capabilities.
        ...
        **kwargs,
        ...
        Args:
            ...
            llm_config (dict or False): llm inference configuration.
                ...
                - assistant_name: Name of the GPT.
        ...
        super().__init__(
            name=name, human_input_mode="NEVER", llm_config=llm_config, **kwargs
        )
        self._create_config['gizmo_id'] = self._openai_assistant_id
    ...
    def assistant_id(self):
        ...
        return self._openai_assistant_id
