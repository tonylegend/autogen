...
class AgentBuilder:
    ...
    # Answer the name of those positions/jobs. Create a new one only when it is not in 'EXISTING_POSITIONS'.
    ...
    def build(
        ...
        **kwargs,
        ...
        if use_api:
            ...
            # agent_name_list = [agent_name.strip().replace(" ", "_").replace("\\", "") for agent_name in resp_agent_name.split(",")]
