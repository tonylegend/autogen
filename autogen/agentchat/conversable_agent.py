...
from autogen.code_utils import UNKNOWN, content_str, execute_code, extract_code, infer_lang, \
    decide_use_docker, check_can_use_docker_or_throw
...
class ConversableAgent(LLMAgent):
    ...
    def generate_oai_reply(
        ...
        extracted_response = self._generate_oai_reply_from_client(
            client, system_message, messages, self.client_cache, sender
        )
        return True, extracted_response

    def _generate_oai_reply_from_client(self, llm_client, system_message, messages, cache, sender):
