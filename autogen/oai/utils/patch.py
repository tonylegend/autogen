...
from autogen.oai.oai_client import AsyncOpenAI, OpenAI
from autogen.oai.utils.types import (
    ChatCompletion,
...
from autogen.oai.utils.multitask import MultiTask, MultiTaskBase
